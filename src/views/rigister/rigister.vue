    ...
    <div class="login-container">
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
            ...
            <el-form-item prop="username">
                ...
                <el-input v-model="loginForm.username" ref="username" placeholder="Username" name="username" type="text"
          ...
          />
            ...
            <div style="display: flex">
                <el-form-item prop="username">
                    ...
                    <el-input v-model="code" ref="username" style="width: 300px" placeholder="code" name="code"
                        type="text" tabindex="1" auto-complete="on" />
                </el-form-item>
                <img src="/api/auths/captcha" style="margin-left: 20px; height: 47px" @click="getVerify($event.target)"
                    alt="" />
            </div>
            <div style="display: flex;">

                <router-link to="/login">
                    <div style="margin-right: 10px;" class="but">
                        login
                    </div>
                </router-link>

                <el-button :loading="loading" type="primary"
                    style="width: 50%; margin-bottom: 30px">rigister</el-button>
