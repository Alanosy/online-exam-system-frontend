  ...
  <div>
    ...
    <div class="bj">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button
          :title="diaTitle"
          type="primary" @click="dialogTableVisible = true" style="margin-left: 10px" > 新增</el-button>
        </el-form-item>
      </el-form>
    </div>
    <!-- table -->
    <div style="width: 90%; margin: auto; margin-top: 20px">
      <el-table :data="tables" border>
        ...
        <el-table-column prop="count" label="班级口令" align="center">
        </el-table-column>
        <el-table-column prop="class" label="班级" align="center" width="150px">
        </el-table-column>
